/********************************************************************************
** Form generated from reading UI file 'delete_sp.ui'
**
...
#ifndef UI_DELETE_SP_H
#define UI_DELETE_SP_H
...
public:
    ...
    void setupUi(QWidget *delete_sp)
    {
        if (delete_sp->objectName().isEmpty())
            delete_sp->setObjectName(QString::fromUtf8("delete_sp"));
        delete_sp->resize(921, 511);
        delete_sp->setMinimumSize(QSize(921, 511));
        delete_sp->setMaximumSize(QSize(921, 511));
        delete_sp->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        tableView = new QTableView(delete_sp);
...
"    height: 0px;\n"
"}"));
        pushButton_4 = new QPushButton(delete_sp);
...
"font-weight: 500;"));
        pushButton = new QPushButton(delete_sp);
...
"}"));
        ...
        pushButton_3 = new QPushButton(delete_sp);
...
"}"));
        label_2 = new QLabel(delete_sp);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(30, 80, 871, 21));
        label_2->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
"font: 75 13pt \"Karla\";"));
        pushButton_2 = new QPushButton(delete_sp);
...
"}"));
        ...
        retranslateUi(delete_sp);

        pushButton->setDefault(false);


        QMetaObject::connectSlotsByName(delete_sp);
    } // setupUi

    void retranslateUi(QWidget *delete_sp)
    {
        delete_sp->setWindowTitle(QApplication::translate("delete_sp", "Form", nullptr));
        pushButton_4->setText(QString());
        label->setText(QApplication::translate("delete_sp", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214 \321\201\321\202\321\203\320\264\320\265\320\275\321\202\320\260 \320\270\320\267 \320\277\321\200\320\276\320\265\320\272\321\202\320\260", nullptr));
        pushButton->setText(QApplication::translate("delete_sp", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214", nullptr));
        pushButton_3->setText(QString());
        label_2->setText(QApplication::translate("delete_sp", "\320\242\320\265\320\274\320\260 \320\277\321\200\320\276\320\265\320\272\321\202\320\260:", nullptr));
...
namespace Ui {
    class delete_sp: public Ui_delete_sp {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DELETE_SP_H
