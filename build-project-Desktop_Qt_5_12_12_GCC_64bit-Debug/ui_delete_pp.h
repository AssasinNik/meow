/********************************************************************************
** Form generated from reading UI file 'delete_pp.ui'
**
...
#ifndef UI_DELETE_PP_H
#define UI_DELETE_PP_H
...
public:
    ...
    void setupUi(QWidget *delete_pp)
    {
        if (delete_pp->objectName().isEmpty())
            delete_pp->setObjectName(QString::fromUtf8("delete_pp"));
        delete_pp->resize(921, 511);
        delete_pp->setMinimumSize(QSize(921, 511));
        delete_pp->setMaximumSize(QSize(921, 511));
        delete_pp->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        pushButton_3 = new QPushButton(delete_pp);
...
"}"));
        pushButton_2 = new QPushButton(delete_pp);
...
"}"));
        label_2 = new QLabel(delete_pp);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(20, 80, 871, 21));
        label_2->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
"font: 75 13pt \"Karla\";"));
        tableView = new QTableView(delete_pp);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(120, 110, 691, 301));
...
"    height: 0px;\n"
"}"));
        pushButton = new QPushButton(delete_pp);
...
"font-weight: 500;"));
        pushButton_4 = new QPushButton(delete_pp);
        ...
        retranslateUi(delete_pp);

        pushButton->setDefault(false);


        QMetaObject::connectSlotsByName(delete_pp);
    } // setupUi

    void retranslateUi(QWidget *delete_pp)
    {
        delete_pp->setWindowTitle(QApplication::translate("delete_pp", "Form", nullptr));
        pushButton_3->setText(QString());
        pushButton_2->setText(QString());
        label_2->setText(QApplication::translate("delete_pp", "\320\242\320\265\320\274\320\260 \320\277\321\200\320\276\320\265\320\272\321\202\320\260:", nullptr));
        pushButton->setText(QApplication::translate("delete_pp", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214", nullptr));
        label->setText(QApplication::translate("delete_pp", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214 \320\277\321\200\320\276\321\204\320\265\321\201\321\201\320\276\321\200\320\260 \320\270\320\267 \320\277\321\200\320\276\320\265\320\272\321\202\320\260", nullptr));
...
namespace Ui {
    class delete_pp: public Ui_delete_pp {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DELETE_PP_H
