/********************************************************************************
** Form generated from reading UI file 'list_of_students.ui'
**
...
#ifndef UI_LIST_OF_STUDENTS_H
#define UI_LIST_OF_STUDENTS_H
...
public:
    ...
    void setupUi(QWidget *list_of_students)
    {
        if (list_of_students->objectName().isEmpty())
            list_of_students->setObjectName(QString::fromUtf8("list_of_students"));
        list_of_students->resize(921, 511);
        list_of_students->setMinimumSize(QSize(921, 511));
        list_of_students->setMaximumSize(QSize(921, 511));
        list_of_students->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        label = new QLabel(list_of_students);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(180, 0, 681, 61));
        label->setStyleSheet(QString::fromUtf8("color: rgb(109, 85, 255);\n"
"font: 75 40pt \"Karla\" bold;\n"
"font-weight: 500;"));
        pushButton_2 = new QPushButton(list_of_students);
...
"}"));
        pushButton_4 = new QPushButton(list_of_students);
        ...
        tableView = new QTableView(list_of_students);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(50, 90, 821, 321));
...
"    height: 0px;\n"
"}"));
        pushButton_3 = new QPushButton(list_of_students);
...
"}"));
        pushButton = new QPushButton(list_of_students);
...
"}"));
        ...
        retranslateUi(list_of_students);

        pushButton->setDefault(false);


        QMetaObject::connectSlotsByName(list_of_students);
    } // setupUi

    void retranslateUi(QWidget *list_of_students)
    {
        list_of_students->setWindowTitle(QApplication::translate("list_of_students", "Form", nullptr));
        label->setText(QApplication::translate("list_of_students", "\320\241\320\277\320\270\321\201\320\276\320\272 \321\201\321\202\321\203\320\264\320\265\320\275\321\202\320\276\320\262", nullptr));
        pushButton_2->setText(QString());
        pushButton_4->setText(QString());
        pushButton_3->setText(QString());
        pushButton->setText(QApplication::translate("list_of_students", "\320\224\320\276\320\261\320\260\320\262\320\270\321\202\321\214", nullptr));
    } // retranslateUi

};

namespace Ui {
    class list_of_students: public Ui_list_of_students {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LIST_OF_STUDENTS_H
